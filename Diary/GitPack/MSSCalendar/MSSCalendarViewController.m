...
#import "ZYCalendarTopView.h" //顶部UI
...
-(void)buildTopView{
    ...
    ZYCalendarTopView * topview = [[ZYCalendarTopView alloc]initWithFrame:CGRectMake(0, 0, KSCREEN_WIDTH, ZYTOP_Height)];
    topview.CalendarTopAcction = ^(NSInteger index) {
...
- (void)addWeakView
{
    UIView *weekView = [[UIView alloc]initWithFrame:CGRectMake(0, ZYTOP_Height, MSS_SCREEN_WIDTH, MSS_WeekViewHeight)];
...
//    flowLayout.headerReferenceSize = CGSizeMake(MSS_SCREEN_WIDTH, MSS_HeaderViewHeight);
    ...
    _collectionView = [[UICollectionView alloc]initWithFrame:CGRectMake(0, ZYTOP_Height +  MSS_WeekViewHeight, width * 7, MSS_SCREEN_HEIGHT - MSS_WeekViewHeight - ZYTOP_Height) collectionViewLayout:flowLayout];
    ...
    [_collectionView registerClass:[ZYCalendInfoCell class] forCellWithReuseIdentifier:@"ZYCalendInfoCell"];
...
-(CGSize)collectionView:(UICollectionView *)collectionView layout:(UICollectionViewLayout *)collectionViewLayout sizeForItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        NSInteger width = MSS_Iphone6Scale(54);
        NSInteger height = MSS_Iphone6Scale(60);
        CGSize size_0 = CGSizeMake(width, height);
        return size_0;
    }
    
 
    CGSize size_1 = CGSizeMake(self.view.frame.size.width, 300);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if(cell)
        {
            ...
            NSLog(@"所有的时间 ----- %ld",(long)calendarItem.dateInterval);
            
            //是不是在选中的时间
            NSArray * arrays = @[@"1509811200",@"1509724800",@"1509552000",@"1510243200"];
            NSString * siginDayStr = [NSString stringWithFormat:@"%ld",(long)calendarItem.dateInterval];
            if ([arrays containsObject:siginDayStr]) {
                cell.isSelected = YES;
   ...
   //说明组
    ZYCalendInfoCell * infoCell = [collectionView dequeueReusableCellWithReuseIdentifier:@"ZYCalendInfoCell" forIndexPath:indexPath];
