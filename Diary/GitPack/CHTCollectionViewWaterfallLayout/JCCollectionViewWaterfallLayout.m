...
- (void)prepareLayout
{
    ...
    for (NSInteger section = 0; section < numberOfSections; section++) {
        ...
        NSMutableDictionary *supplementary = [NSMutableDictionary dictionary];
...
//        NSLog(@"collectionView ietms %ld",(long)itemCount);
...
{
//    NSLog(@"这个数组是不是空   %@",self.supplementaryAttributes);
